...
export default function HistoryModal({
  ...
  const entries = useMemo(() => {
    const all = [...participant.entries].sort((a, b) =>
  ...
  const stats = useMemo(() => {
    ...
    const progreso = computeProgress(
  ...
  return (
    <div className="fixed inset-0 bg-black/40 grid place-items-center z-50">
      ...
      <div className="bg-white rounded-2xl shadow-xl w-[95vw] max-w-3xl p-5 max-h-[90vh] overflow-y-auto">
        {/* Cabecera sticky para que el botón Cerrar siempre esté visible */}
        <div className="flex items-center justify-between mb-3 sticky top-0 bg-white pt-1 pb-3 z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4 text-sm">
            ...
            <div className="p-3 rounded-xl bg-slate-50 border">
              ...
              <div
                className={`font-semibold ${
                  stats.delta >= 0 ? "text-amber-700" : "text-emerald-700"
                }`}
              >
            ...
            <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-100 col-span-2 md:col-span-1">
              ...
              <div className="font-semibold">
                {stats.direccion} · {stats.progresoPct}%
              </div>
            </div>
          </div>
        )}
